...
subsequent steps for any possible transition for the “up” action, so Q(\begin{math}s_0\end{math}, ‘up’) = 0.33
\begin{math}V_1 + 0.33 \dot V_2 + 0.33 \dot V_4 = 0.33 \dot 1 + 0.33 \dot 2 + 0.33 \dot 4 = 2.31\end{math}.

Repeating this for the rest of s0 actions results in the following:
